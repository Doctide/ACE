...
namespace ACE.Server.WorldObjects
{
    partial class BountyContract : WorldObject
    {
        ...
        public string BuildBountyContractLongDescription()
        {
            ...
            if (BountyCompleted)
                return $"The bounty contract for {name} has been completed and is awaiting turn in. Please turn in the bounty contract to the bounty NPC to receive your rewards.";
