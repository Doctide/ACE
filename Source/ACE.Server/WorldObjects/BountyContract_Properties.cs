...
namespace ACE.Server.WorldObjects
{
    partial class BountyContract
    {
        ...
        public int BountyKillStreakCount
        {
            get => GetProperty(PropertyInt.BountyKillStreakCount) ?? 0;
            set { if (value == 0) RemoveProperty(PropertyInt.BountyKillStreakCount); else SetProperty(PropertyInt.BountyKillStreakCount, value); }
        }

        public int BountyContractState
        {
            get => GetProperty(PropertyInt.BountyContractState) ?? 0;
            set { if (value == 0) RemoveProperty(PropertyInt.BountyContractState); else SetProperty(PropertyInt.BountyContractState, value); }
        }
    }
}
