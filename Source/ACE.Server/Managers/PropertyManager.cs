    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("pvp_ratings_mod_dmg", new Property<double>(1.0, "Scales the bonus received from dmg and dmg reduction ratings during pvp")),
                ("pvp_ratings_mod_critdmg", new Property<double>(1.0, "Scales the bonus received from crit dmg and crit dmg reduction ratings during pvp")),
